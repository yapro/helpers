...
class StringHelper
{
    // Вытащил все символы с сайта https://invisible-characters.com/ (если нужно добавить новый, то узнать его код можно на странице https://invisible-characters.com/view.html )
