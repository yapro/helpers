...
class StringHelper
{
    ...
    public function getWithoutInvisibleSymbols(string $string): string
    {
    ...
    // Стоит помнить, что из Textarea приходит \r\n (даже в Ubuntu), а \r\n удаляется функцией getWithoutInvisibleSymbols, 
    // поэтому если нужно сохранить перенос строки, то перед этим стоит выполнять: str_replace("\r\n", PHP_EOL, 'your html');
